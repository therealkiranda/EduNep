...
export default function AccountantLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarActiveTintColor: '#1B6CA8', tabBarInactiveTintColor: '#9CA3AF', tabBarStyle: { backgroundColor: '#fff', borderTopColor: '#F3F4F6', height: 60, paddingBottom: 8 }, tabBarLabelStyle: { fontFamily: 'DMSans-Medium', fontSize: 10 } }}>
      ...
      <Tabs.Screen name="invoices"  options={{ title: 'Invoices',  tabBarIcon: p => <TabIcon emoji="🧾" {...p} /> }} />
      <Tabs.Screen name="payments"  options={{ title: 'Payments',  tabBarIcon: p => <TabIcon emoji="💳" {...p} /> }} />
      <Tabs.Screen name="payroll"   options={{ title: 'Payroll',   tabBarIcon: p => <TabIcon emoji="💵" {...p} /> }} />
